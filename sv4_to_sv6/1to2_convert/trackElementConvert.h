...
BYTE RCT1to2trackElementConversionTable[RCT_NUMTRACKELEMENTS]=
{
	...
	/*0x65*/ 0x65, /*{reserved}RCT2: inverted 90 /\ to flat quarter loop (multidim)*/
	...
	/*0x6E*/ 0x6E, /*{ride base: 2 X 2} RCT2: 25 /\ L banked*/
	/*0x6F*/ 0x6F, /*{ride base: 4 X 4} RCT2: 25 /\ R banked*/
	/*0x70*/ 0x70, /*waterfall */
	/*0x71*/ 0x71, /*rapids */
	/*0x72*/ 0x72, /*on ride photo */
	/*0x73*/ 0x73, /*{reserved}RCT2: 25 \/ L banked*/
	...
	/*0xCD*/ 0xCD, /*RCT2: mini golf hole E*/
	/*0xCE*/ 0xCE, /*RCT2: inverted flat to 90 \/ quarter loop (multidim)*/
	/*0xCF*/ 0xCF, /*RCT2: Quarter loop 90 /\ to invert*/
	/*0xD0*/ 0xD0, /*RCT2: Quarter loop invert to 90 \/*/
	/*0xD1*/ 0xD1, /*RCT2: L curved lift hill*/
	/*0xD2*/ 0xD2, /*RCT2: R curved lift hill*/
	...
	/*0xD8*/ 0xD8, /*Block Brakes*/
	/*0xD9*/ 0xD9, /*L ¼ D3 25 /\ banked*/
	/*0xDA*/ 0xDA, /*R ¼ D3 25 /\ banked*/
	/*0xDB*/ 0xDB, /*L ¼ D3 25 \/ banked*/
	/*0xDC*/ 0xDC, /*R ¼ D3 25 \/ banked*/
	/*0xDD*/ 0xDD, /*L ¼ D5 25 /\ banked */
	/*0xDE*/ 0xDE, /*R ¼ D5 25 /\ banked*/
	/*0xDF*/ 0xDF, /*L ¼ D5 25 \/ banked*/
	/*0xE0*/ 0xE0, /*R ¼ D5 25 \/ banked*/
	/*0xE1*/ 0xE1, /*25 /\ to L bank 25 /\*/
	/*0xE2*/ 0xE2, /*25 /\ to R bank 25 /\*/
	/*0xE3*/ 0xE3, /*L bank 25 /\ to 25 /\*/
	/*0xE4*/ 0xE4, /*R bank 25 /\ to 25 /\*/
	/*0xE5*/ 0xE5, /*25 \/ to L bank 25 \/*/
	/*0xE6*/ 0xE6, /*25 \/ to R bank 25 \/*/
	/*0xE7*/ 0xE7, /*L bank 25 \/ to 25 \/*/
	/*0xE8*/ 0xE8, /*R bank 25 \/ to 25 \/*/
	/*0xE9*/ 0xE9, /*L bank to L bank 25 /\*/
	/*0xEA*/ 0xEA, /*R bank to R bank 25 /\*/
	/*0xEB*/ 0xEB, /*L bank 25 /\ to L bank flat */
	/*0xEC*/ 0xEC, /*R bank 25 /\ to R bank flat */
	/*0xED*/ 0xED, /*L bank to L bank 25 \/*/
	/*0xEE*/ 0xEE, /*R bank to R bank 25 \/*/
	/*0xEF*/ 0xEF, /*L bank 25 \/ to L bank flat*/
	/*0xF0*/ 0xF0, /*R bank 25 \/ to R bank flat*/
	/*0xF1*/ 0xF1, /*flat to L bank 25 /\*/
	/*0xF2*/ 0xF2, /*flat to R bank 25 /\*/
	/*0xF3*/ 0xF3, /*L bank 25 /\ to flat*/
	/*0xF4*/ 0xF4, /*R bank 25 /\ to flat*/
	/*0xF5*/ 0xF5, /*flat to L bank 25 \/*/
	/*0xF6*/ 0xF6, /*flat to R bank 25 \/*/
	/*0xF7*/ 0xF7, /*L bank 25 \/ to flat*/
	/*0xF8*/ 0xF8, /*R bank 25 \/ to flat*/
	/*0xF9*/ 0xF9, /*L ¼ D1 90 /\*/
	/*0xFA*/ 0xFA, /*R ¼ D1 90 /\*/
	/*0xFB*/ 0xFB, /*L ¼ D1 90 \/*/
	/*0xFC*/ 0xFC, /*R ¼ D1 90 \/*/
	/*0xFD*/ 0xFD, /*90 /\ to inverted flat quarter loop (multidim)*/
	/*0xFE*/ 0xFE, /*flat to 90 \/ quarter loop (multidim)*/
