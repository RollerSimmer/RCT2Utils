...
typedef enum
{	
	SV4__STT_FOODSTALL=	0x1C,	//Food Stall (all types)
	SV4__STT_DRINKSTALL=	0x1E,	//	Drink Stall (all types)
	SV4__STT_SHOP=		0x20,	//	Shop (all types)
	SV4__STT_INFOKIOSK=	0x23,	//Information Kiosk 
	SV4__STT_RESTROOM=	0x24,	//Bathroom (both types)   
	SV4__STT_ATM=		0x2D,	//ATM
	SV4__STT_FIRSTAID=	0x30	//First Aid
} RCT_SHOPTRACKTYPE;
...
typedef SV4_PARKMAPDATA* SV4_LPPARKMAPDATA;

#define SV4__MAP_MAXTILES	128
...
typedef struct 
{
	...
	BYTE		
		...
		fillFA[2],
		items[4];
} SV4_SPRITESTRUCT,SV4_SPRITESTRUCTARRAY[NUMSPRITES];
...
typedef struct 
{
	...
	BYTE
		...
		//17A..25F : ? 
		fill17A[0x260-0x17A];
} SV4_RIDESTRUCT, SV4_RIDESTRUCTARRAY[256];
