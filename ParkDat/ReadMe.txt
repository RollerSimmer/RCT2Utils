========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : ParkDat
========================================================================


AppWizard has created this ParkDat application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your ParkDat application.
...
res\ParkDat.ico
    ...
    icon is included by the main resource file ParkDat.rc.
...
ParkDatDlg.h, ParkDatDlg.cpp - the dialog
    These files contain your CParkDatDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in ParkDat.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CParkDatDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named ParkDat.pch and a precompiled types file named StdAfx.obj.
